...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mitra Legalitas UMKM" },
      { name: "description", content: "Solusi legalitas Nib dan Npwp" },
      { name: "author", content: "Mitra Legalitas UMKM" },
      { property: "og:title", content: "Mitra Legalitas UMKM" },
      { property: "og:description", content: "Solusi legalitas Nib dan Npwp" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Mitra Legalitas UMKM" },
      { name: "twitter:description", content: "Solusi legalitas Nib dan Npwp" },
      { property: "og:site_name", content: "Mitra Legalitas UMKM" },
